...
exports.customerMutation = {
    ...
    customerVerifyOtp: (_1, _a, _b) => __awaiter(void 0, [_1, _a, _b], void 0, function* (_, { data }, { req }) { return services_1.CustomerService.customerVerifyOtp({ data: data, req }); }),
    customerCreatePassword: (_1, _a, _b) => __awaiter(void 0, [_1, _a, _b], void 0, function* (_, { data }, { req }) { return services_1.CustomerService.customerCreatePassoword({ data: data, req }); }),
    customerResendOTP: (_1, _a, _b) => __awaiter(void 0, [_1, _a, _b], void 0, function* (_, { data }, { req }) { return services_1.CustomerService.customerRendOTP({ data: data, req }); }),
